...
Public Class AssessReport2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IT_ProjectManager.AssessReport2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAssessReport2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AssessReport2 = New AssessReport2()
        rpt.Site = Me.Site
        Return rpt
    End Function
