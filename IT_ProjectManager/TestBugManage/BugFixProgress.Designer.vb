...
Partial Class BugFixProgress
    ...
    Private Sub InitializeComponent()
        ...
        Me.btBugEntry.Text = "變更"
        Me.btBugEntry.ToolTip = "修改反饋信息"
        '
        'lblTestStandard
        '
        ...
        Me.GroupControl1.Text = "Bug修復人：xxxx"
        '
        'lblImpactRemarks
        '
        ...
        Me.btBugDesignate.Text = "變更"
        Me.btBugDesignate.ToolTip = "修改回覆信息，前提是確認人未確認"
        '
        'LabelControl17
        '
        ...
        Me.btResults.Text = "變更"
        Me.btResults.ToolTip = "修改確認信息"
        '
        'lblConfirmResults
        '
